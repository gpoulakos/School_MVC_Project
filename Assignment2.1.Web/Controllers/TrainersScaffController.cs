...
{
    public class TrainersScaffController : Controller
    {
        ...
        // GET: TrainersScaff/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: TrainersScaff/Create
